...
<div class="bg-white rounded-lg shadow-md p-6 max-w-7xl mx-auto">
    ...
    <form action="{{ route('admin.attendances.store') }}" method="POST" class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-6 gap-3">
            ...
            <div>
                <label for="waktu_keluar" class="block text-sm font-semibold text-gray-700 mb-2">
                    Waktu Keluar
                </label>
                <input type="time" 
                       id="waktu_keluar" 
            ...
            <div>
                <label for="status_absensi" class="block text-sm font-semibold text-gray-700 mb-2">
        ...
        <div class="mt-4 flex justify-end">
            <button type="submit" class="w-full md:w-auto px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-2">
